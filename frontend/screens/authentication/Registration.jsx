                ...
                {({
                    ...
                    <View>
                         <View style={styles.wrapper}>
                            ...
                            <View>
                                <View style={[styles.inputContainer, { borderColor: `${touched.username ? COLORS.lightBlue : COLORS.lightGray}` }]}>
                                    <MaterialCommunityIcons name='face-man-outline' size={20} color={COLORS.gray} />
                                    <View style={{ width: 20 }} />
                                    <TextInput onChangeText={handleChange("username")} placeholder='Enter your username' onFocus={() => { setFieldTouched("username") }} onBlur={() => { setFieldTouched("username", "") }} value={values.username} autoCapitalize='none' autoCorrect={false} style={{ flex: 1 }} />
                                </View>
                        ...
                        <ReusableButton onPress={() => { handleSubmit }} title={"REGISTER"} width={SIZES.width - 40} bgColor={COLORS.green} borderColor={COLORS.green} borderWidth={0} textColor={COLORS.white} />
                    </View>
                )}
            </Formik>
        </View>
